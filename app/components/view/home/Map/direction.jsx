    ...
    return (
      <Box>
        <Box className="flex items-center justify-between py-3">
          ...
          <Box className="flex items-center justify-center bg-gray-200 rounded-full w-5 h-5 p-px cursor-pointer" onClick={() => setStage("")}>
            <IconifyIcon
              icon="tabler:x"
        ...
        <Box className="flex items-center h-28 mt-4">
          ...
          <Box className="w-10 flex-shrink-0 flex justify-center ">
            <IconifyIcon
              icon="tabler:x"
              className="!text-gray-500 flex-shrink-0 !text-[18px]"
            />
          </Box>
        </Box>
